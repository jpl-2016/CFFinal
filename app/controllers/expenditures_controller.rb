class ExpendituresController < ApplicationController
  ...
  private
    ...
    def expenditure_params
      params.require(:expenditure).permit(:campaign_finance_info_id, :entity_id, :expend_type_id, :expend_category_id, :payment_method_id, :date, :amount, :description, :istraveloutsideoftx, :isaustintxlivingexpense, :isbenefitcoh, :isreimbursementintended)
    end
end
