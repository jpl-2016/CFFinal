class CohPaymentsController < ApplicationController
  ...
  private
    ...
    def coh_payment_params
      params.require(:coh_payment).permit(:campaign_finance_info_id, :entity_id, :expend_category_id, :date, :amount, :description, :istraveloutsideoftx, :isaustintxlivingexpense, :isbenefitcoh)
    end
end
